...
# OTMB18-35 was used for ALCT copper link
# will be replaced by optical ALCT data
...
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[0]]
set_property PACKAGE_PIN     AE26       [get_ports ALCT[0]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[1]]
set_property PACKAGE_PIN     AF22       [get_ports ALCT[1]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[2]]
set_property PACKAGE_PIN     AG22       [get_ports ALCT[2]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[3]]
set_property PACKAGE_PIN     AE22       [get_ports ALCT[3]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[4]]
set_property PACKAGE_PIN     AE23       [get_ports ALCT[4]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[5]]
set_property PACKAGE_PIN     AG21       [get_ports ALCT[5]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[6]]
set_property PACKAGE_PIN     AL17       [get_ports ALCT[6]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[7]]
set_property PACKAGE_PIN     AP16       [get_ports ALCT[7]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[8]]
set_property PACKAGE_PIN     AG17       [get_ports ALCT[8]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[9]]
set_property PACKAGE_PIN     AG16       [get_ports ALCT[9]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[10]]
set_property PACKAGE_PIN     AN18       [get_ports ALCT[10]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[11]]
set_property PACKAGE_PIN     AN17       [get_ports ALCT[11]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[12]]
set_property PACKAGE_PIN     AM17       [get_ports ALCT[12]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[13]]
set_property PACKAGE_PIN     AN16       [get_ports ALCT[13]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[14]]
set_property PACKAGE_PIN     AK15       [get_ports ALCT[14]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[15]]
set_property PACKAGE_PIN     AL15       [get_ports ALCT[15]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[16]]
set_property PACKAGE_PIN     AP15       [get_ports ALCT[16]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[17]]
set_property PACKAGE_PIN     AM16       [get_ports ALCT[17]]
set_property IOSTANDARD      LVCMOS18   [get_ports ALCT[17]]
set_property PULLTYPE        PULLUP     [get_ports ALCT[17]]
...
## AE15 is RSVTD7, come from E9 pin of the OTMB connector
## by checking with ODMB schematic this is the ALCTDAV signal
set_property PACKAGE_PIN     AE15       [get_ports ALCTDAV] 
set_property IOSTANDARD      LVCMOS18   [get_ports ALCTDAV]

set_property PACKAGE_PIN     AD15       [get_ports OTMBDAV]
set_property IOSTANDARD      LVCMOS18   [get_ports OTMBDAV]
